export default function Footer() {
  return (
    <footer className="bg-foreground-light border-t border-gray-200">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-10 lg:px-20 pb-8 pt-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="col-span-1 lg:col-span-4">
            <h4 className="font-bold text-lg mb-4">ABOUT US</h4>
            <p className="text-sm text-text-muted-light">
              Red's Shoes & More is the intersection of luxury, design, and culture. We are committed to crafting footwear that stands the test of time, both in style and quality.
            </p>
            <p className="text-sm text-text-muted-light mt-4">Contact: redshoes8523@gmail.com</p>
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">About Us</a></li>
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">FAQs</a></li>
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">Privacy Policy</a></li>
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">Shipping Policy</a></li>
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">Terms of Service</a></li>
            </ul>
          </div>
          <div className="col-span-1 lg:col-span-2">
            <h4 className="font-bold text-lg mb-4">CUSTOMER SERVICE</h4>
            <ul className="space-y-3">
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">Contact Us</a></li>
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">Help Center</a></li>
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">Track Your Order</a></li>
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">Exchanges &amp; Returns</a></li>
              <li><a className="text-sm text-text-muted-light hover:text-primary transition-colors" href="#">Referral Program</a></li>
            </ul>
          </div>
          <div className="col-span-1 lg:col-span-4 bg-background-light p-6 rounded-xl">
            <h4 className="font-bold text-lg">7% Welcome Discount</h4>
            <p className="text-sm text-text-muted-light mt-1 mb-4">Subscribe to our newsletter and get a special discount.</p>
            <form className="space-y-4">
              <input className="w-full h-10 px-3 text-sm border-gray-300 bg-foreground-light rounded-md focus:ring-primary focus:border-primary" placeholder="Enter your email address" type="email" />
              <input className="w-full h-10 px-3 text-sm border-gray-300 bg-foreground-light rounded-md focus:ring-primary focus:border-primary" placeholder="Phone number (optional)" type="tel" />
              <div className="flex items-start">
                ...
                <label className="ml-2 text-xs text-text-muted-light" htmlFor="sms-consent">I consent to receive marketing SMS messages.</label>
              </div>
        ...
        <div className="text-center text-xs text-text-muted-light mt-16 border-t border-gray-200 pt-8">
          © 2025 Red's Shoes & More. All Rights Reserved. A luxury footwear experience.
        </div>
      </div>
    </footer>
  )
